---
name: issues
description: Создает github issues и milestones из файла плана. Использовать, когда есть готовый план с фазами, и нужно создать бэклог на github.
---
...
3. Для каждой  задачи в фазу создай Issue:
